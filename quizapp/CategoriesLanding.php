...
<!-- This is the page admin users are redirected to upon login -->
<!-- Head section -->
<head>
    <meta charset="UTF-8">
    <!-- Title -->
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <div class="usersection">
                ...
                <form action="scoreperC.php" method="post" >
            ...
            <div class="usersection">
                ...
                <!-- Description of admin options section -->
                <span id="usersectiontext">
                    <p>
                        <strong>For admin users only.</strong> Use to manage categories and</br>
                        questions, as well as add new admin users.
                    </p>
                </span>
                <!-- Manage categories -->
                <form action="catman.php">
                    <input type="submit" value="Manage Categories"/>
                </form>
                <!-- Manage questions -->
                <form action="Qman.php">
                    <input type="submit" value="Manage Questions"/>
                </form>
                <!-- Add new admin user -->
                <form action = "AAdd.php">
